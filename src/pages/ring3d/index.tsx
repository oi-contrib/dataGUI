...
class Ring3D extends React.Component {
    ...
    componentDidMount() {
        ...
        let painter = getWebGLContext(this.refContent.current, 1, "aspectFill")
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            // 计算切割份数
            let splitNum = Math.ceil(deg * this.refContent.current.clientHeight * 0.1)
